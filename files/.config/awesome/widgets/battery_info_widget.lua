...
the_widget.text_color=theme.battery_info_widget_color
the_widget:set_fg(the_widget.text_color)

local home=os.getenv("HOME")

watch("python3 "..home.."/.config/awesome/widgets/formatted-output.py battery_info_widget", 10, function(widget, stdout, stderr, exitreason, exitcode)
