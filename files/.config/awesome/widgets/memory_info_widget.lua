...
the_widget.text_color=theme.memory_info_widget_color
the_widget:set_fg(the_widget.text_color)

local home=os.getenv("HOME")

watch("python3 "..home.."/.config/awesome/widgets/formatted-output.py memory_info_widget", 1, function(widget, stdout, stderr, exitreason, exitcode)
